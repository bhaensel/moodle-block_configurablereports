...
require_once($CFG->dirroot.'/blocks/configurable_reports/report.class_e2.php');
...
if (!$download) {
	...
	//echo '<link rel="stylesheet" type="text/css" href="/theme/essential/style/dash.css">';
	echo '<link rel="stylesheet" type="text/css" href="style/hover.css">';	
    //echo $OUTPUT->header();
